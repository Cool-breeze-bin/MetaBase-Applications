...
import com.huawei.hms.modeling3d.sceneview.SceneViewActivity;
...
public class HomeFragment extends Fragment {
    ...
    @OnClick({R.id.rl_create_model, R.id.rl_create_material, R.id.rl_my_material, R.id.rl_my_model,R.id.rl_create_motion,R.id.rl_upload_file,R.id.go_sceneview})
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.rl_upload_file:
                ...
                break;
            case R.id.go_sceneview:
                Context context = getActivity().getApplicationContext();
                Intent rgbIntent = new Intent(context, SceneViewActivity.class);
                startActivity(rgbIntent);
                break;
        }
    }
